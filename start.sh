...
USER_ID=$(id -u) GROUP_ID=$(id -g) DOCKER_FILE_LOCATION=$DEVELOPMENT_ENVIRONMENT_DIRECTORY docker-compose -f $DOCKER_COMPOSE_FILE_LOCATION up --build fusion-development -d
